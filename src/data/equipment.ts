...
export const equipment: Equipment[] = [
  {
    ...
    reviews: 48,
    popular: true,
    description: "Профессиональная акустическая система для больших площадок и фестивалей.",
    specs: { "Мощность": "1500 Вт", "Частотный диапазон": "55 Гц — 20 кГц", "Чувствительность": "102 дБ", "Вес": "38 кг" },
    tags: ["концерт", "фестиваль", "аутдор"],
  },
  {
    id: 2,
    name: "Микшер Yamaha CL5",
    category: "Звук",
    price: 2800,
    unit: "день",
    rating: 5,
    reviews: 31,
    popular: true,
    description: "Цифровой микшерный пульт с 72 каналами для профессиональных постановок.",
    specs: { "Каналы": "72", "Фейдеры": "24", "Процессор": "DSP", "Интерфейс": "Dante" },
    tags: ["микширование", "концерт", "театр"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    reviews: 26,
    popular: false,
    description: "Активный сабвуфер с карdioid-режимом для управляемой направленностью баса.",
    specs: { "Мощность": "3600 Вт", "Динамики": "2×12\"", "Частота": "36 — 100 Гц", "Вес": "45 кг" },
    tags: ["бас", "концерт", "клуб"],
  },
  {
    id: 11,
